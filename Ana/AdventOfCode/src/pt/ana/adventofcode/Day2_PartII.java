...
public class Day2_PartII {
	...
	public static int calculateArea(List<String> dimensions) {
		...
		for (String string : dimensions) {
			...
			if (eachDim.length != 3) {
				...
				int secondSmallest = list.get(list.size()-1);
				
				widthBow = widthBow + (2* smallest + 2* secondSmallest) + (lenght * width * height);

				System.out.println("Total width for " + string + " is: " + widthBow);
			}
	...
	public static void main(String[] args) {
		System.out.println(calculateArea(dimensions));
	}
}