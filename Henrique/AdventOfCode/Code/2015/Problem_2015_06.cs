...
public partial class Problem_2015_06 : Problem
{
    ...
    private string SolvePart1()
    {
        ...
        foreach (string line in InputLines)
        {
            ...
            try
            {
                ...
                startPosition = new(int.Parse(initialPositionX), int.Parse(initialPositionY));

                string finalPositionX = match.Groups[4].Value;
                string finalPositionY = match.Groups[5].Value;
                endPosition = new(int.Parse(finalPositionX), int.Parse(finalPositionY));
    ...
    private void UpdateLightsGrid(Operation operation, Coordinates startPosition, Coordinates endPosition)
    {
    ...
    private void UpdateBrightnessGrid(Operation operation, Coordinates startPosition, Coordinates endPosition)
    {
        int xi = startPosition.X;
        int yi = startPosition.Y;
