...
{
    private List<Coordinates> visitedHouses;
    private Coordinates SantaLastVisitedHouse;
    private Coordinates RoboSantaLastVisitedHouse;
    ...
    {
        visitedHouses = [];
        SantaLastVisitedHouse = new(0, 0);
        RoboSantaLastVisitedHouse = new(0, 0);
    }
    ...
    {
        Coordinates lastVisitedHouse = (moveTurn == MoveTurn.Santa) ? SantaLastVisitedHouse : RoboSantaLastVisitedHouse;
        Coordinates newVisitedHouse = new(lastVisitedHouse.X - 1, lastVisitedHouse.Y);
    ...
    {
        Coordinates lastVisitedHouse = (moveTurn == MoveTurn.Santa) ? SantaLastVisitedHouse : RoboSantaLastVisitedHouse;
        Coordinates newVisitedHouse = new(lastVisitedHouse.X, lastVisitedHouse.Y + 1);
        InsertHouse(newVisitedHouse, moveTurn);
    }
    ...
    private void InsertHouse(Coordinates newVisitedHouse, MoveTurn moveTurn)
    {
